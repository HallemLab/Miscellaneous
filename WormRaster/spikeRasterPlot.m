classdef spikeRasterPlot < matlab.graphics.chartcontainer.ChartContainer & ...
    ...
    % Modified by Astra S. Bryant, PhD - 8/12/2022

    % This code as written relies on the validatecolor command only
    % included in 2020b. To make this code work on earlier versions of
    % matlab, removing some calls to validatecolor, making some
    % version-dependent.
    ...
    properties (Dependent)
        ...
        ColorOrder = get(groot, 'factoryAxesColorOrder')
    ...
    methods (Access = protected)
        function setup(obj)
            ...
            obj.SpikeLines = plot(ax, minutes(NaN), categorical(NaN), ...
                'SeriesIndex', 1);
